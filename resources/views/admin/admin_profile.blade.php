    ...
    <div class="row profile-body">
      ...
      <div class="d-none d-md-block col-md-4 col-xl-4 left-wrapper">
        <div class="card rounded">
          <div class="card-body">   
            <div>
                <img class="wd-70 rounded-circle" src="{{ (!empty($profileData->photo) ? url('uploads/admin_images/'.$profileData->photo) : url('uploads/no_image.jpg')) }}" alt="profile image">
        ...
        <div class="row">
                <div class="card">
                  <div class="card-body">
                        ...
                        <h6 class="card-title">Update Admin's Data</h6>
                        ...
                        <form method="POST" action="{{ route('admin.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="image" name="photo" class="form-control" type="file" id="formFile">
                            </div>

                            <div class="mb-3">
                                <img id="showImage" class="wd-90 rounded-circle" src="{{ (!empty($profileData->photo) ? url('uploads/admin_images/'.$profileData->photo) : url('uploads/no_image.jpg')) }}" alt="profile image">
                            </div>
