                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample" method="post" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="login" name="login" placeholder="Email/Username or Phone">
                      </div>
                      <div class="mb-3">
                      ...
                      <div>
                        <button type="submit" name="submit" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">
                          Login
                        </button>
                      </div>
